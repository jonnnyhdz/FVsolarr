                                    ...
                                    <div class="row g-4 align-items-start">
                                        <div class="col-sm-6 col-xl-3">
                                            <div class="bg-secondary rounded d-flex flex-column align-items-end p-4">
                                                ...
                                                <input class="form-control border-0 rounded-pill my-2" type="text" pattern="[0-9]{10}" name="numeroServicio" id="numeroServicio" required placeholder="Ingrese 10 números">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-xl-3">
                                            <div class="bg-secondary rounded d-flex flex-column align-items-end p-4">
                                                <label for="fechaFacturacion">Fecha de Facturación:</label>
                                                <input  class="form-control border-0 rounded-pill  my-2" type="date" name="fechaFacturacion" id="fechaFacturacion" required><br>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-xl-3">
                                            <div class="bg-secondary rounded d-flex flex-column align-items-end p-4">
                                                <label  class="text-center" for="tipoTarifa">Tipo:</label>
                                                <select  class="form-control border-0 rounded-pill  my-2" name="tipoTarifa" id="tipoTarifa" required onchange="generarFechas()">
                                        ...
                                        <div class="col-sm-6 col-xl-3">
                                            <div class="bg-secondary rounded d-flex flex-column align-items-end p-4">
                                                ...
                                                <select  class="form-control border-0 rounded-pill  my-2" name="tipoServicio" id="tipoServicio" required onchange="generarFechas()">
