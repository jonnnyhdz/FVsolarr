...
$updateProyecto2 = "UPDATE proyectos 
SET ID_MFV='$id_seleccionado',HSP='$HSP', NOMBRE_PROYECTO='$nombreP',Energiarequerida='$Renergiarequerida',PotenciopicoFV='$RpotenciapicoFV',Areatotal='$areatotal',NumerosdeModulos='$RedondeoNMAXMFV', Ubicacion='$ubi' WHERE ID_PROYECTO='$id_proyecto'";
