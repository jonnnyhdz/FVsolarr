...
<body>
    <div class="espacios2"> <strong>  Vmp <sub>min</sub> : </strong>  <span style="color: red;"> <?php echo $CalculoVmpp; ?> V </span> </div>
    <div class="espacios2"> <strong>  VOC <sub>max </sub> : </strong> <span style="color: red;"> <?php echo $CalculoVoc; ?> V </span> </div>
</body>
